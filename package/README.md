...
## Original mod by DaXcess. Updated by gingerphoenix10.
99% of the following text was written by DaXcess.
<br><br>
...
The source code for this mod is available on GitHub! Check it out: [gingerphoenix10/CWVR](https://github.com/gingerphoenix10/CWVR).

### License

This mod is licensed under the GNU General Public License version 3 (GPL-3.0). For mote info check [LICENSE](https://github.com/gingerphoenix10/CWVR/blob/main/LICENSE).
...
For a list of default controls, check out the controls [wiki page](https://thunderstore.io/c/content-warning/p/DaXcess/CWVR/wiki/1966-controls/) on Thunderstore. (links to the original mod's wiki, as I don't know how to setup a Thunderstore wiki :3)